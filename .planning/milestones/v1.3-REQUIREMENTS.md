# Requirements Archive: v1.3 Interactive Map & Editorial Polish
...
**Shipped:** 24 of 24 v1.3 requirements
**Adjusted:**
- MAP-08: Originally specified "click outside closes panel" — implemented as deliberate trade-off where dialog.show() (non-modal) keeps map interactive, so native backdrop close is unavailable; X button and Escape key close the panel; documented as intentional design decision
- VIS-02: EB Garamond font loading required gap closure in Phase 27 (Font tag was missing from BaseLayout.astro)
- VIS-04: Required additional Phase 26-03 plan to implement independent sub-section parallax (original single-section approach insufficient)

**Dropped:** None — all 24 requirements shipped.
