# Requirements Archive: v1.6 Segment Editorial & Polish
...
- [x] **DESC-01**: All 7 segment descriptions rewritten to 35-55 words with surface-first + ecology + experience structure
- [x] **DESC-02**: Descriptions grounded in LANDFIRE ecological zone data (specific tree species, understory, substrate type)
- [x] **DESC-03**: Descriptions synced across RouteExplainer.astro, generate-sector-details.js, and regenerated sector-details.json
...
| DESC-01 | Phase 39 | Complete |
| DESC-02 | Phase 39 | Complete |
| DESC-03 | Phase 39 | Complete |
...
**Shipped:** 6 of 6 v1.6 requirements
**Adjusted:** LABEL-01 resolved by removal rather than enlargement (user-directed after testing)
**Dropped:** None

---
*Archived: 2026-04-07 as part of v1.6 milestone completion*
